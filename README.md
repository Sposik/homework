...
- Импортирование из Excel и CSV файлов.


###   Декоратор `log`
- **Логирование в консоль или файл**  
  Вывод можно направить в файл (через параметр `filename`) или в консоль.
- **Детализация ошибок**  
  При возникновении исключений логируются:
  - Имя функции
  - Тип ошибки
  - Аргументы вызова
- **Сохранение сигнатуры функций**  
...
### Добавлен полный функционал. Запуск через main.py
